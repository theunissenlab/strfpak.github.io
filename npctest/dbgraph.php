  ...
  ***/
  class svdChart  {
    ...
    function prepare() {
      ...
      $this->valueincrement = $this->highestvalue / $this->leftlegend;
    ...
    function generateChartHtml() {
      ...
      $fn=array("images/blue.jpg","images/green.jpg","images/red.jpg",
                "images/black.jpg",
      ...
      if ($this->width > 0) {
        echo("<table cellspacing=0 width=" . $this->width . ">\n"); //border=1
      } else {
        echo("<table>\n");
      }
      
      echo("<tr><td colspan=".(count($this->bartitle)+1)." align=center>\n");
      echo($this->title . "<br><HR ALIGN=CENTER SIZE=1 WIDTH=100% NOSHADE>");
      echo("</td></tr>\n");

      echo("<tr>\n");


      //echo("<td align=center valign=bottom rowspan=".($this->leftlegend) .">\n");
      //for($gr=0;$gr<count($this->barheight);$gr++){
      //  if (""!=$this->legend[$gr]){
      //    echo("<img border=0 src=\"" . $fn[$gr] . "\" width=$bw height=$bw>");
      //    echo("&nbsp;" . $this->legend[$gr]);
      //  }
      //}
      //echo("</td>\n");
      ...
      echo(round($this->highestvalue) . "-</td>\n");
      ...
      // rest of number axis
      for($i=2;$i<=$this->leftlegend;$i++){
        echo("<tr><td valign=top align=right>\n");
        echo(round($this->highestvalue-($this->valueincrement*($i-1))) . "-</td></tr>\n");
      }
